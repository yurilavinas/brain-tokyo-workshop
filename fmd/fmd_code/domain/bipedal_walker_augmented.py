...
class AugmentBipedalWalkerHardcore(gym.Env):
    metadata = {
    ...
    def __init__(self, augment_reward=True):
        ...
        self.scale_vector = list(np.random.randint(1,3,8)) # random integer [-2,2], to include 2 use 2nd par as 3
        self.seed()
        self.viewer = None
...
class AugmentBipedalWalkerHardcore(AugmentBipedalWalkerHardcore):
    hardcore = True
    smalllegs = True
    talllegs = True
